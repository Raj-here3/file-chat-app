package com.whatsappclone.client;

import com.whatsappclone.util.FileTransfer;
import com.whatsappclone.gui.ChatGUI;

import java.io.*;
import java.net.*;

public class Client {
    private static final String SERVER_ADDRESS = "172.20.116.60"; // Replace with your server's IP address
